...
module.exports.connection = function (socket) {
  ...
  socket.join(room_id, () => {
    ...
    console.log(rooms);
    // module.exports._namespace.to(room_id).emit("a new user has joined the room");
  ...
  //       var name = info.name;
  //       socket.username = name;
  //       online_user_name.push(name);
  //       console.log(online_user_name);
  //       module.exports._namespace.to(room_id).emit("update", {count: online_user_count.toString(), name_list: online_user_name.toString()});
  //   })
  socket.on("send", (msg) => {
